...
for i in range(1):
    ...
    # Carregando a SqueezeNet pré-treinada
    model = models.squeezenet1_1(pretrained=True)

    # Congelando os pesos das camadas iniciais
    for param in model.parameters():
        param.requires_grad = False

    # Substituindo a última camada para se adequar ao número de classes do seu problema
    ...
    # Crie o diretório com incremento, se necessário
    parent_dir = create_incremented_dir('resultados', 'MNISTSqueezePreNet')
