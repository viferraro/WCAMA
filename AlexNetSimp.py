...
for i in range(1):
    ...
    # Crie o diretório pai 'alexNet_x' e o subdiretório 'alexNetModelos'
    parent_dir = create_dir('resultados', f'alexNet_{i + 1}')
    sub_dir = create_dir(parent_dir, 'alexNetModelos')
    ...
    for i in range(num_models):
        ...
        # Salva as métricas de cada modelo em um arquivo separado no subdiretório 'alexNetModelos'
    ...
    # Salve a matriz de confusão e as métricas do melhor modelo no diretório pai 'alexNet_x'
